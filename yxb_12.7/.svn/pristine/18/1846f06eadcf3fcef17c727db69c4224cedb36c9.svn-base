...
@interface LoanCenterViewController1 ()<HeaderViewDelegate,UITableViewDataSource,UITableViewDelegate,QCBaseTableViewDelegate>
{
...
@implementation LoanCenterViewController1
-(void)dealloc{
