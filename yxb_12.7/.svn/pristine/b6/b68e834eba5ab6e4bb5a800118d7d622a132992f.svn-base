...
@interface MyLoanViewController : QCBaseViewController<MyIOUHeaderViewDelegate,YanqiViewDelegate,ConsultLixiViewDelegate,UITableViewDataSource,UITableViewDelegate,QCBaseTableViewDelegate,MyLoanListDialogBgViewDelegate,MyLoanListBottomViewDelegate,UITextFieldDelegate,UIAlertViewDelegate,MyLoanListRequireVideoAlertDelegate,CTAlertViewDelegate,MyLoanCuishouAlertDelegate>
