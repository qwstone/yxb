...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            {
                return CATransform3DTranslate(transform, www*radius * sin(angle), 0.0, radius * cos(angle) - radius);
            }
        }
        case iCarouselTypeCylinder:
        case iCarouselTypeInvertedCylinder:
...
- (void)updateNumberOfVisibleItems
{
    ...
    _numberOfVisibleItems = MAX(1, MIN(_numberOfVisibleItems, _numberOfItems + _numberOfPlaceholdersToShow));
