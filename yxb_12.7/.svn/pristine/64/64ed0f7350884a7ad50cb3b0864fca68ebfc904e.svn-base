        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = NSLocalizedString(@"请前往设置打开无忧借条访问照片权限", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedString(@"访问被拒绝", nil) message:errorMessage delegate:nil cancelButtonTitle:NSLocalizedString(@"Ok", nil) otherButtonTitles:nil] show];
