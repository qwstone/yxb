...
-(void)createDialogView{
    MyLoanListDialogRectView *tDialogRectView = [[MyLoanListDialogRectView alloc] initWithFrame:CGRectMake(0, 0, 153, 133) andTopImgName:@"myLoanList_DialogLeftTop" cenImgName:@"myLoanList_DialogCent" bottomImgName:@"myLoanList_DialogFoot"];
    self.dialogRectView = tDialogRectView;
    [self.contentView addSubview:tDialogRectView];
    
    _delayBgView = [[UIView alloc] initWithFrame:CGRectMake(8, 0, 153-8, 133)];
    ...
    NSArray *arr = @[@"待还金额:",@"延期补偿:",@"应还总额:",@"延至时间:"];
    for (int i = 0; i < 4; i ++) {
        UILabel *leftLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, headerImgView.bottom+i*25+5, 50, 25)];
