...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(kDeviceWidth, 100000) options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:label.font} context:nil].size;
