...
#define kILAlertViewMessageFont [UIFont systemFontOfSize:20]
#define kILAlertViewButtonFont [UIFont boldSystemFontOfSize:18]
...
//        [self addSubview:_titleLabel];
        ...
        _view1.backgroundColor=rgb(222, 222, 222, 1.0);
        [self addSubview:_view1];
        
        _view2=[[UIView alloc]init];
        _view2.backgroundColor=rgb(222, 222, 222, 1.0);
        ...
        NSMutableAttributedString *mAttStri = [[NSMutableAttributedString alloc] initWithString:_messageView.text];
        [mAttStri addAttribute:NSForegroundColorAttributeName value:[UIColor redColor] range:NSMakeRange(13,2)];
                _messageView.attributedText=mAttStri;
        _messageView.textAlignment = NSTextAlignmentCenter;
        _messageView.font = [UIFont systemFontOfSize:18.0];
...
//        _messageView.attributedText=mAttStri1;
        ...
        if (secondTitle) {
            ...
            [_secondButton setTitleColor:rgb(68, 152, 228, 1.0)forState:UIControlStateNormal];
            [_secondButton setTitleColor: rgb(68, 152, 228, 1.0) forState:UIControlStateHighlighted];
        ...
        [_closeButton setTitleColor:rgb(68, 152, 228, 1.0) forState:UIControlStateNormal];
        [_closeButton setTitleColor:rgb(68, 152, 228, 1.0) forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    if (_message != nil) {
        ...
        _messageView.frame = CGRectMake(10,
                                        yOffset,
                                        mainSize.width-20,
                                        messageHeight);
    ...
    _view1.frame=CGRectMake(0, _messageView.frame.size.height+_messageView.frame.origin.y , self.frame.size.width, 1);
    _view2.frame=CGRectMake(self.frame.size.width/2, _messageView.frame.size.height+_messageView.frame.origin.y , 1, 40);
    /* Buttons */
